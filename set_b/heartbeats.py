...
# --- EDA ---
dfA = pd.read_csv('/kaggle/input/heartbeat-sounds/set_a.csv')
dfB = pd.read_csv('/kaggle/input/heartbeat-sounds/set_b.csv')
dfAtiming = pd.read_csv('/kaggle/input/heartbeat-sounds/set_a_timing.csv')
...
dir = '/kaggle/input/heartbeat-sounds/'
